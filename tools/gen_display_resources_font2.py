...
parser.add_argument('--output_c_file', type=argparse.FileType('a'), required=True)
...
for x, c in enumerate(filtered_characters):
    ...
    start_y = (tile_y - 3) - (g["bounds"][1] + g["bounds"][3])
...
c_file.write("""\
displayio_tilegrid_t supervisor_terminal_font2_text_grid = {{
    .base = {{ .type = &displayio_tilegrid_type }},
    .bitmap = (displayio_bitmap_t*) &supervisor_terminal_font2_bitmap,
...
c_file.write("""\
const uint32_t font2_bitmap_data[{}] = {{
...
c_file.write("""\
displayio_bitmap_t supervisor_terminal_font2_bitmap = {{
    .base = {{.type = &displayio_bitmap_type }},
    .width = {},
    .height = {},
    .data = (size_t*) font2_bitmap_data,
    .stride = {},
    .bits_per_value = 1,
    .x_shift = 5,
    .x_mask = 0x1f,
...
c_file.write("""\
const fontio_builtinfont_t supervisor_terminal_font2 = {{
    .base = {{.type = &fontio_builtinfont_type }},
    .bitmap = &supervisor_terminal_font2_bitmap,
    .width = {},
    .height = {},
...
terminalio_terminal_obj_t supervisor_terminal = {
    ...
    .font = &supervisor_terminal_font2,
    .cursor_x = 0,
    .cursor_y = 0,
    .tilegrid = &supervisor_terminal_font2_text_grid
};
""")
'''
